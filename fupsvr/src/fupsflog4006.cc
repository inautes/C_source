...
{
	infLOG(ALWAY,"------------fupsflog4006 start-------------\n");
	...
	{
		infLOG(ERROR, "fupsflog4006 : socket() errno [ %d ] error msg [ %s ]\n",errno,strerror(errno));
		return(-2); 
	...
	infLOG(ALWAY, "fupsflog4006 : 40061 전송 sizeof(CFUPS4006) = %ld  \n",sizeof(CFUPS4006));
	if(SendData(dcmd_socket,pSendData, dwSendDataLen ) <= 0)
	{
		infLOG(ERROR, "fupsflog4006 : 40061 전송 SendData() errno [ %d ] error msg [ %s ]\n",errno,strerror(errno));
		...
		infLOG(ERROR, "fupsflog4006 통신 오류(S) : 서버와의 통신 오류 입니다. 1분후 재시도 해주십시오. \n");
	...
	{
		infLOG(ERROR, "fupsflog4006 : 40061 받기 RecvData() errno [ %d ] error msg [ %s ]\n",errno,strerror(errno));
	...
	infLOG(ALWAY,"fupsflog4006 : result - dcmdHeader.nCmd [ %d ] \n",dcmdHeader.nCmd);
	...
	{
		infLOG(ERROR, "fupsflog4006 : 40061 결과 오류 [ %d ] \n",dcmdHeader.nCmd );
