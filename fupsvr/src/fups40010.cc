...
long fups40010(CFUPS4001 pfups4001)
{
		...
		{
			infLOG(ERROR, "fups40010[ERR]: 소켓 생성 오류 입니다.\n");
	...
	{
		infLOG(ERROR, " ]fups40010[ERR]중개서버 접속 오류 : [ %s ] [ %d ]  \n 다음 서버(%s)로 접속합니다. \n"
		...
		{
			#ifdef __DEBUG
			printf(" ] fups40010 요청 패킷 전송 \n");
			#endif					
			infLOG(ERROR, " ] fups40010 요청 패킷 전송 \n");
		...
		if(RecvData(dcmd_socket,(char*)&dcmdHeader,HEADER_SIZE ) <= 0)
		{
			...
			infLOG(ERROR, "fups40010[ERR]: 40010 통신 오류(R1) : 서버와의 통신 오류 입니다. 1분후 재시도 해주십시오. \n");
		...
		{
			infLOG(ERROR, "fups40010[ERR]: 40010 통신 오류(R2) : 서버와의 통신 오류 입니다. 1분후 재시도 해주십시오. \n");
