...
# ---------------------------------------------------------------------------
# common directory
COMMBIN = $(HOME)/project1/server/zangsi_with_dcmd/rbin_local
...
DEBUGS	= -D_THREAD_MODULE_ -D_THREAD_SAFE -D_REENTRANT -D__LOCALTEST 
#CFLAGS  = $(DEBUGS) 
...
cleanall:
	...
	@make  -f real_local.mk cleancmdserver cleancmdserver_c cleanfdnserver cleanfupserver cleandcmdserver cleaninstallserver
