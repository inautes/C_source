...
//          -1(DB오류)
//******************************************************************************
long com9002dsp(CCOM9002_R pcom9002_r,int nFlag,char* szIP, int nPort)
{
	...
	{
		 infLOG(ERROR, " ]com9003[ERR]중개서버 접속 오류 : [ %s ] [ %d ]  \n " ,szIP,nPort);
	...
	if( nFlag == 1)
	{
		dcmdHeader.nCmd = 900211;
	}
	else
	{
		dcmdHeader.nCmd = 900210;
	}
