...
MYSQL *db_connect1(const char *dbname)
{
	...
	if (!mysql_real_connect(db, OSP_DB_IP, OSP_DB_USER, OSP_DB_PASS , dbname, 0, NULL, 0))
...
MYSQL *db_connect(char *dbname)
{
	...
	if (!mysql_real_connect(db, OSP_DB_IP_PUB, OSP_DB_USER, OSP_DB_PASS , dbname, 0, NULL, 0))
	{
...
MYSQL *db_connect_backup(char *dbname)
{
	...
	if (!mysql_real_connect(db, OSP_DB_IP_BCK, OSP_DB_USER, OSP_DB_PASS , dbname, 0, NULL, 0))
	{
	//	printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
...
MYSQL *Cpr_db_connect(char *dbname)
{
	...
	if (!db)
	{
//		printf("Cpr_db_connect: mysql_init failed(no memory)\n");
		return NULL;
	}
	//printf("db_connect: mysql_init ok! \n");

	if (!mysql_real_connect(db, OSP_CPR_DB_IP, OSP_CPR_DB_USER, OSP_CPR_DB_PASS , dbname, 0, NULL, 0))
	{
//		printf("Cpr_db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
	//printf("db_connect: mysql_real_connect ok! \n");
...
MYSQL *Cpr_db_connect(char *dbname,char *ip,char *user,char *passwd)
{
	//printf("db_connect: start! \n");
...
MYSQL *Hadoop_db_connect(char *dbname)
{
	...
	if (!mysql_real_connect(db, OSP_TONG_DB_IP, OSP_TONG_DB_USER, OSP_TONG_DB_PASS , dbname, 0, NULL, 0))
	{
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
...
MYSQL *Hadoop_db_connect(char *dbname,char *ip,char *user,char *passwd)
{
	//printf("db_connect: start! \n");
...
MYSQL *dnlog_db_connect(char *dbname)
{
	//printf("db_connect: start! \n");
	...
	if (!mysql_real_connect(db, OSP_LOG_DB_IP_PUB	,OSP_DB_DCMD_USER	,OSP_DB_DCMD_PASS , dbname, 0, NULL, 0))
	{
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
