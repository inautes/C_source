...
# ---------------------------------------------------------------------------
# common directory
COMMBIN = $(HOME)/project1/server/zangsi_with_dcmd/rbin_local_211
...
DEBUGS	= -D_THREAD_MODULE_ -D_THREAD_SAFE -D_REENTRANT -D__LOCALTEST_211 
#CFLAGS  = $(DEBUGS) 
...
CC_COM9106  = com9106.cc	#Upload 서버 파일 정보 저장 (wedisk/mydata)
...
# ---------------------------------------------------------------------------
TARGET1 = $(COMMBIN)/we_cmdserver
TARGET1_1 =$(COMMBIN)/we_cmdserver_c
TARGET3 = $(COMMBIN)/we_fdnserver
TARGET4 = $(COMMBIN)/we_fupserver
TARGET5 = $(COMMBIN)/we_dcmdserver
TARGET6 = $(COMMBIN)/we_dnmserver
TARGET7 = $(COMMBIN)/we_installserver
...
cleanall:
	...
	@make  -f real_local_211.mk cleancmdserver cleancmdserver_c cleanfdnserver cleanfupserver cleandcmdserver cleaninstallserver
