...
# ---------------------------------------------------------------------------
# common directory
COMMBIN = $(HOME)/project1/server/zangsi_with_dcmd/rbin_tong
...
DEBUGS	= -D_THREAD_MODULE_ -D_THREAD_SAFE -D_REENTRANT -D__TONGTEST
#CFLAGS  = $(DEBUGS) 
...
cleanall:
	...
	@make  -f real_tong_test.mk cleancmdserver cleancmdserver_c cleanfdnserver cleanfupserver cleandcmdserver cleaninstallserver
