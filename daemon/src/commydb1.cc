...
MYSQL *db_connect_subdb(char *dbname)
{
	...
	if (!mysql_real_connect(db, "192.168.0.101", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0))
	{
		ZzLOG(ERROR, "db_connect:mysql_real_connect failed((%s))", mysql_error(db));
		return NULL;
	}
...
MYSQL *db_connect_local(char *dbname)
{
	...
	if (!mysql_real_connect(db, "192.168.0.38", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0)) // main
	{
		ZzLOG(ERROR, "db_connect:mysql_real_connect failed((%s))", mysql_error(db));
		return NULL;
	}
...
MYSQL *db_connect_backup(char *dbname)
{
	...
	if (!mysql_real_connect(db, "192.168.0.36", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0))
	{
...
MYSQL *db_connect_sumdb(char *dbname)
{
	...
	if (!mysql_real_connect(db, "192.168.0.36", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0))     // 2013.11.25 : 61.252.171.127(192.168.0.127) zangsi_sum DB에 접근하고 있는 ip를
	{
		ZzLOG(ERROR, "db_connect:mysql_real_connect failed((%s))", mysql_error(db));
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
...
MYSQL *db_connect_logdb(char *dbname)
{
	...
	if (!mysql_real_connect(db, "192.168.0.126", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0)) // 61.252.171.126
	{
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
...
MYSQL *db_connect_omdb(char *dbname) // 사용 안함.
{
	...
	if (!mysql_real_connect(db, "192.168.0.121", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0))
	{
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
...
MYSQL *db_connect_search_db(char *dbname)
{
	...
	if (!mysql_real_connect(db, "124.217.217.99", "dmonc", "akqthtk!#%", dbname, 0, NULL, 0))
	{
		printf("db_connect: mysql_real_connect failed(%s)\n", mysql_error(db));
		return NULL;
	}
