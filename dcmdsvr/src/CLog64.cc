...
int CLog64::initLog(char* pLogPath,char* pLogName)
{
	...
	{
		strcpyA(m_szLogPath,pLogPath, sizeof(m_szLogPath));
		strcpyA(m_szLogName,pLogName, sizeof(m_szLogName));
		strcpyA(m_szFullLogPath,m_szLogPath, sizeof(m_szFullLogPath));
